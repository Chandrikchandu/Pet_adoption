...
function printTable($title, $result) {
    if ($result->num_rows > 0) {
        ...
        echo "<table border='3'>";
        echo "<tr><th>ID</th><th>Name</th><th>Breed</th><th>Age</th><th>Gender</th><th>Description</th><th>Price</th><th>Image</th></tr>";
        $id = 1; // Initialize ID
...
$sql_cats = "SELECT * FROM cats";
$result_cats = $conn->query($sql_cats);
printTable("CATS", $result_cats);
